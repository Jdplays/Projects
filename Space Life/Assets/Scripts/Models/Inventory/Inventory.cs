...
// or potentially a non-installed copy of NestedObject (e.g. a cabinet still in the box from Ikea).
[MoonSharpUserData]
...
public class Inventory : IXmlSerializable, ISelectable, IContextActionProvider
{
    ...
    public bool CanBePickedUp(bool canTakeFromStockpile)
    {
        ...
        return Tile.NestedObject == null || canTakeFromStockpile == true || Tile.NestedObject.HasTypeTag("Storage") == false;
    }
