...
public class ShipManager
{
    ...
    // Maps a berth NestedObject to the ship that is currently berthed at it.
    // A non-existent key or value of null means the berth is unoccupied.
    private Dictionary<NestedObject, Ship> berthShipMap;
    ...
    public ShipManager()
    {
        ...
        berthShipMap = new Dictionary<NestedObject, Ship>();
    }
    ...
    /// <summary>
    /// Returns true if this berth is currently holding a ship. Returns false if the NestedObject is not a berth.
    /// </summary>
    /// <param name="berth">The berth NestedObject object.</param>
    public bool IsOccupied(NestedObject berth)
    {
    ...
    /// </summary>
    /// <param name="berth">The berth NestedObject object.</param>
    public Ship GetBerthedShip(NestedObject berth)
    {
        return berthShipMap.ContainsKey(berth) ? berthShipMap[berth] : null;
    }
    ...
    /// </summary>
    /// <param name="berth">The berth NestedObject object.</param>
    public void DeberthShip(NestedObject berth)
    {
