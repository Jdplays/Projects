...
public class ModsManager
{
    ...
    {
        LoadFunctions("NestedObject.lua", "NestedObject");
        ...
        LoadPrototypes("NestedObject.xml", PrototypeManager.NestedObject.LoadPrototypes);
        ...
        LoadPrototypes("Drone.xml", PrototypeManager.Drone.LoadPrototypes);
