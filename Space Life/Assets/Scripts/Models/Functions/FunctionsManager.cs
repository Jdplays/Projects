...
public class FunctionsManager
{
    ...
    public FunctionsManager()
    {
        ...
        actions.Add("NestedObject", new LuaFunctions());
    ...
    /// <summary>
    /// Gets the NestedObject Lua Functions.
    /// </summary>
    /// <value>The NestedObject Lua Functions.</value>
    public static LuaFunctions NestedObject
    {
        get { return Get("NestedObject"); }
    }
