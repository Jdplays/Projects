    ...
    public class Room : IXmlSerializable
    {
        ...
        public List<Tile> FindExits()
        {
            ...
            foreach (Tile tile in tiles)
            {
                ...
                {
                    if (tile2 != null && tile2.NestedObject != null)
                    {
                        if (tile2.NestedObject.IsExit())
                        {
        ...
        public List<Tile> GetBorderingTiles()
        {
            ...
            foreach (Tile tile in tiles)
            {
                ...
                foreach (Tile tile2 in neighbours)
                {
                    if (tile2 != null && tile2.NestedObject != null)
                    {
                        if (tile2.NestedObject.RoomEnclosure)
                        {
                            // We have found an enclosing NestedObject, which means it is on our border
