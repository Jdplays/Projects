...
public class KeyboardManager
{
    ...
    public void ReadXml()
    {
        ...
        RegisterInputMapping("RotateNestedObjectLeft", KeyboardInputModifier.None, KeyCode.Q);
        RegisterInputMapping("RotateNestedObjectRight", KeyboardInputModifier.None, KeyCode.E);

        RegisterInputMapping("Pause", KeyboardInputModifier.None, KeyCode.Space, KeyCode.Pause);

        RegisterInputMapping("DevMode", KeyboardInputModifier.None, KeyCode.F10);
    }
