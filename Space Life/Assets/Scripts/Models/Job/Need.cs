...
public class Need : IPrototypable
{
    ...
    private Need(Need other)
    {
        ...
        RestoreNeedObj = other.RestoreNeedObj;
    ...
    public NestedObject RestoreNeedObj { get; private set; }
        ...
        while (reader.Read())
        {
            switch (reader.Name)
            {
                case "Name":
                    ...
                    break;
                case "RestoreNeedNestedObjectType":
                    reader.Read();
                    RestoreNeedObj = PrototypeManager.NestedObject.Get(reader.ReadContentAsString());
                    break;
