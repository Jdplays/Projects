...
namespace SpaceLife.Jobs
{
    ...
    public class RequestedItem
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SpaceLife.Job.RequestedItem"/> class with the amount needed to fill the inventory item passed in.
        /// </summary>
