...
public class Job : ISelectable, IPrototypable
{
    ...
    // things like placing NestedObject, moving stored inventory,
    // working at a desk, and maybe even fighting enemies.
    public Tile tile;

    public IBuildable buildablePrototype;

    // The piece of NestedObject that owns this job. Frequently will be null.
    ...
    public Pathfinder.GoalEvaluator IsTileAtJobSite
    {
        get
        {
            ...
            // TODO: This doesn't handle multi-tile NestedObject
    ...
    public void SetTileFromNeedNestedObject(Tile currentTile, string needNestedObject)
    {
        tile = SpaceLife.Pathfinding.Pathfinder.FindPathToNestedObject(currentTile, needNestedObject).Last();
    }
    ...
    public void DoWork(float workTime)
    {
        ...
        {
            FunctionsManager.NestedObject.Call(luaFunction, this);
        }
    ...
    public void CancelJob()
    {
        ...
        // If we are a NestedObject building job, Let our workspot tile know it is no longer reserved for us.
        if (buildablePrototype != null)
        {
            World.Current.UnreserveTileAsWorkSpot((NestedObject)buildablePrototype, tile);
        }
...
//        World.Current.jobWaitingQueue.Remove(this);
    ...
    {
        return string.Empty;    //FIXME: Add this later
    }
