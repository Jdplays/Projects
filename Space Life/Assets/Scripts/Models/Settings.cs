...
<Settings>
  <worldWidth>201</worldWidth>
  <worldHeight>201</worldHeight>
...
";
    ...
    private static void LoadSettings()
    {
        ...
        Debug.Log(userSettingsFilePath);
        ...
        // If that doesn't work fall back to the hard coded NestedObjectXmlText above.
    ...
    {
        string nestedObjectXmlText = FallbackSettingsXML;
        ...
        else
        {
            try
            {
                nestedObjectXmlText = System.IO.File.ReadAllText(DefaultSettingsFilePath);
            }
            catch (Exception e)
            {
