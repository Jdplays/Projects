...
public class WorldController : MonoBehaviour
{
    ...
    public NestedObjectSpriteController nestedObjectSpriteController;
    ...
    public void Start()
    {
        ...
        nestedObjectSpriteController = new NestedObjectSpriteController(World);
        utilitySpriteController = new UtilitySpriteController(World);
        jobSpriteController = new JobSpriteController(World, nestedObjectSpriteController, utilitySpriteController);
        inventorySpriteController = new InventorySpriteController(World, inventoryUI);
        shipSpriteController = new ShipSpriteController(World);

        buildModeController = new BuildModeController();
        spawnInventoryController = new SpawnInventoryController();
        mouseController = new MouseController(buildModeController, nestedObjectSpriteController, utilitySpriteController, circleCursorPrefab);
    ...
    public void ChangeDevMode()
    {
        ...
        ///NestedObjectBuildMenu.instance.RebuildMenuButtons(developerMode);
    }

    private void CreateEmptyWorld()
    {
        // get world size from settings
        int width = Settings.GetSetting("worldWidth", 201);
        int height = Settings.GetSetting("worldHeight", 201);
